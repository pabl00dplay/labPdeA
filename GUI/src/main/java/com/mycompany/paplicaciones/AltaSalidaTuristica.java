...
public class AltaSalidaTuristica extends javax.swing.JPanel {
    ...
    public AltaSalidaTuristica() {
        ...
        jComboBoxDepto.addItem(" ");
        List<Departamento>ld=I.getDepartamentos();
        Iterator<Departamento> itr=ld.iterator();
        while(itr.hasNext()){
            jComboBoxDepto.addItem(itr.next().getNom());
        }
        jComboBoxActividad.removeAllItems();
        jComboBoxActividad.addItem(" ");
    }
